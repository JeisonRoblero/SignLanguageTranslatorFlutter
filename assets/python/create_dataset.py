...
DATA_DIR = 'assets/python/data'  # Ruta al directorio donde se encuentran los datos.
...
f = open('assets/python/data.pickle', 'wb')  # Abre un archivo llamado 'data.pickle' en modo de escritura binaria.
